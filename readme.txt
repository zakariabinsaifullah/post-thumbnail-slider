...
Contributors: webackstop, binsaifullah, mamnur
Donate link: 
Tags: posts, post slider, post thumbnail, thumbnail slider, post featured image, featured image slider
...
Post Thumbnail Slider is a light-weight, slick but powerful thumbnail slider making plugin that allows you to show the post thumbnail with the title in different styles and positions in a sliding mode.

== Description ==

**Post Thumbnail Slider** is a light-weight, slick but powerful thumbnail slider making plugin that allows you to **<i>show the post thumbnail with the title in different styles and positions in a sliding mode</i>**.
